...
TestSupport$AssertionFailedException::TestSupport$AssertionFailedException(const TestSupport$AssertionFailedException& e) {
}

TestSupport$AssertionFailedException TestSupport$AssertionFailedException::wrapper$() {
	$pendingException(this);
	return *this;
}

void TestSupport$AssertionFailedException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
